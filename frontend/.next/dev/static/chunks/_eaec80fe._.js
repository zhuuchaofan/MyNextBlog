...
"[project]/components/CommentsSection.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CommentsSection({ postId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CommentsSection.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchComments"])(postId).then({
                "CommentsSection.useEffect": (data)=>{
                    if (data.success) setComments(data.comments);
                    setLoading(false);
                }
            }["CommentsSection.useEffect"]).catch({
                "CommentsSection.useEffect": ()=>setLoading(false)
            }["CommentsSection.useEffect"]);
        }
    }["CommentsSection.useEffect"], [
        postId
    ...
    const handleSubmit = async (e)=>{
        ...
        setSubmitting(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["submitComment"])(postId, content, guestName);
            if (data.success) {
                // 将新评论添加到列表开头
                setComments([
                    data.comment,
...
_s(CommentsSection, "FwkGntp6+BfmoApHMUbZbj8/A60=");
_c = CommentsSection;
var _c;
...
//# sourceMappingURL=_eaec80fe._.js.map